...
![AI thinking check](examples/images/ai-thinking-check.png)

### 把一个想法拆成可执行的小步骤

```text
Use $cat-note-illustrations 为“把一个想法拆成可执行的小步骤”生成一张正文配图。
```

![Idea to steps](examples/images/idea-to-steps.png)

### 发现工作流里的断点

```text
Use $cat-note-illustrations 为“发现工作流里的断点”生成一张正文配图。
```

![Workflow breakpoint](examples/images/workflow-breakpoint.png)
